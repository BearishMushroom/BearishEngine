...
namespace Bearish { namespace Graphics {
	...
	class BEARISH_API Attenuation : public Core::IAllocatable<Attenuation> {
	public:
	...
	class BEARISH_API DirectionalLight : public Light {
	public:
	...
	class BEARISH_API PointLight : public Light {
	public:
	...
	class BEARISH_API SpotLight : public PointLight {
	public:
